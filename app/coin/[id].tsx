...
function FavoritesIcon({ filled, theme }: { filled: boolean; theme: any }) {
    return (
        <Svg
            width={24}
            height={24}
...
export default function CoinDetailScreen() {
    ...
    const loadChart = async () => {
        ...
        try {
            ...
            const formatted = prices.map(([timestamp, value]) => ({ timestamp, value }));
                ...
                <View style={styles.actionBar}>
                    ...
                    <View style={styles.actions}>
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.7}
                        >
                            <FavoritesIcon filled={isFavorite} theme={theme} />
                        </TouchableOpacity>
                    </View>
                </View>
...
function makeStyles(theme: any) {
    return StyleSheet.create({
        ...
        image_symbol: { flexDirection: 'row', alignItems: 'center' },
        image: { width: 24, height: 24, marginRight: 8, marginLeft: 8 },
        symbol: { color: theme.text.primary, fontSize: 20, fontWeight: 'bold' },
